package com.bbc.criticaltechworks.ui.screen.splash
...
import com.bbc.criticaltechworks.util.BiometricStatus
import com.bbc.criticaltechworks.util.BiometricUtil
import com.bbc.criticaltechworks.util.VerticalSpacer
...
fun SplashScreen(
    ...
    Surface(
        ...
        SplashScreenBody(navHostController = navHostController, mainViewModel = mainViewModel)
    }
